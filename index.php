...
<!--						<i class="zmdi zmdi-landscape"></i>-->
                ...
                <br>
                <div class="container-login100-form-btn">
                    <h6 >ليس لديك حساب ؟ <a href="SignUp.php"><span style="color:white"> إنشاء حساب</span></a></h6>
                </div>

                <div class="container-login100-form-btn">
                    <h6 >هل نسيت كلمة المرور ؟ <a href="reset.php"><span style="color:white">تغيير كلمة السر</span></a></h6>
                </div>
