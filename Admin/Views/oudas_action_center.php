                                        ...
                                        <table class="table table-bordered"  id="tabledata"  style="text-align:center;">
                                            ...
                                            if($today < $row["slot_date"]) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["slot_time_to"] ?></td>
...
<!--                                                    <td>--><?php //echo $row["ansqu"] ?><!--</td>-->
                                                    ...
                                                    if($row["shown"] == 'N') {
                                                        ?>
                                                        <td>
                                                            <a href="../../Controller/oudas_action_controller.php?id=<?php echo $row["slot_id"] ?>&status=Y"><input
                                                                    type="button" name="del" value="Show To users"
                                               ...
                                               ?>
                                               <td>
                                                   <a href="../../Controller/oudas_action_controller.php?id=<?php echo $row["slot_id"] ?>&status=N"><input
                                                           type="button" name="del" value="Show To Admin only"
