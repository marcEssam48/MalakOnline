                        ...
                        <div class="card card-stats">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <?php
                                    $sql = "select users.user_id,username,mobile,nid,user_slot.category as ct,user_slot.attended as at from users join user_slot on users.user_id = user_slot.user_id where slot_id = $slot_id " ;
