                            ...
                            <div class="card card-stats">
                                <div class="card-body ">
                                    <div class="row" style="overflow:auto;">
                                        ...
                                        <?php
                                        $sql = "SELECT username,nid,mobile,next_available_date from users where user_type ='U' and next_available_date > '$today '";
                                        ...
                                        <table class="table table-bordered"  id="tabledata"  style="text-align:center;">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"> ميعاد الحجز القادم</th>
                                            ...
                                            if($result->num_rows>0)
                                            {
                                                while($row = $result->fetch_assoc())
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["next_available_date"]?></td>
